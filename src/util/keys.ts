...
export const StarsDimInAtmosphereKey = 'Scene.Stars.Renderable.DimInAtmosphere';
export const StarsRenderableKey = 'Scene.Stars.Renderable';
export const StarLabelsRenderableKey = 'Scene.StarsLabels.Renderable';
export const StarLabelsAlternateRenderableKey = 'Scene.StarLabelsAlternate.Renderable';
export const MoonPerformShadingKey = 'Scene.Moon.Renderable.PerformShading';
