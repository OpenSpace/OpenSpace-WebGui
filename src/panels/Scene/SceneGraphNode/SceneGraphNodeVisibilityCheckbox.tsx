...
import { useSceneGraphNodeVisibility } from '@/hooks/propertyOwner';
...
export function SceneGraphNodeVisibilityCheckbox({ uri, label }: Props) {
  const { isVisible, setVisibility } = useSceneGraphNodeVisibility(uri);
